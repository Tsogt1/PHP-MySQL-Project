            ...
            <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                ...
                <div class="logo">
                    <a href="index.php">
                        ...
                        <h2>Hello there, This My PHP Project, TsogtB</h2><!-- Home Shopping Portal -->
                    </a>
                </div>
            </div>
                            ...
                            <div class="cart-item product-summary">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        ...
                                        <h3 class="name"><a
                                                href="index.php?page-detail"><?php echo $row['productName']; ?></a></h3>
                                        <div class="price">
                                            CAD<?php echo ($row['productPrice'] + $row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?>
                                        </div>
                                    </div>
                            ...
                            <div class="clearfix cart-total">
                                <div class="pull-right">
                                    ...
                                    <span class="text">Total :</span><span
                                        class='price'>CAD<?php echo $_SESSION['tp'] = "$totalprice" . ".00"; ?></span>
