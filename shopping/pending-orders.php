                            ...
                            <form name="cart" method="post">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $query = mysqli_query($con, "select products.productImage1 as pimg1,products.productName as pname,products.id as c,ordeCADproductId as opid,ordeCADquantity as qty,products.productPrice as pprice,products.shippingCharge as shippingcharge,ordeCADpaymentMethod as paym,ordeCADorderDate as odate,ordeCADid as oid from orders join products on ordeCADproductId=products.id where ordeCADuserId='" . $_SESSION['id'] . "' and ordeCADpaymentMethod is null");
    $cnt = 1;
        ...
        while ($row = mysqli_fetch_array($query)) {
            ?>
                                        <tr>
                                            ...
                                            <td><a href="pending-ordeCADphp?id=<?php echo $row['oid']; ?> ">Delete</td>
                                        </tr>
                                        <?php $cnt = $cnt + 1;}?>
                                        <tr>
                                            <td colspan="9">
