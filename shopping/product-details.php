                                ...
                                <div class="item">
                                    <div class="products">
                                        <div class="hot-deal-wrapper">
                                            <div class="image">
                                                <img src="admin/productimages/<?php echo htmlentities($rws['productName']); ?>/<?php echo htmlentities($rws['productImage1']); ?>"
                                        ...
                                        <div class="product-info text-left m-t-20">
                                            ...
                                            <div class="product-price">
                                                <span class="price">
                                                    CAD <?php echo htmlentities($rws['productPrice']); ?>.00
                                                </span>

                                                <span
                                                    class="price-before-discount">CAD<?php echo htmlentities($row['productPriceBeforeDiscount']); ?></span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="price-box">
                                                ...
                                                <span
                                                    class="price-strike">CAD<?php echo htmlentities($row['productPriceBeforeDiscount']); ?></span>
                                            </div>
                                        </div>
                    ...
                    <div class="products">
                        <div class="product">
                            ...
                            <div class="product-info text-left">
                                ...
                                <div class="product-price">
                                    <span class="price">
                                        CAD<?php echo htmlentities($rw['productPrice']); ?> </span>
                                    <span class="price-before-discount">CAD
